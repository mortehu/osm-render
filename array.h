...
#define ARRAY_REMOVE(array, index)                                            \
  do                                                                          \
    {                                                                         \
      size_t cindex;                                                          \
      assert((array)->array_result == 0);                                     \
      assert((array)->array_element_count > 0);                               \
      cindex = (index);                                                       \
      --(array)->array_element_count;                                         \
      memmove((array)->array_elements + cindex,                               \
              (array)->array_elements + cindex + 1,                           \
...
#define ARRAY_REMOVE_SEVERAL(array, index, count)                             \
  do                                                                          \
    {                                                                         \
      size_t ccount, cindex;                                                  \
      assert((array)->array_result == 0);                                     \
      ccount = (count);                                                       \
      cindex = (index);                                                       \
      assert((array)->array_element_count >= ccount);                         \
      (array)->array_element_count -= ccount;                                 \
      memmove((array)->array_elements + cindex,                               \
              (array)->array_elements + cindex + ccount,                      \
              ((array)->array_element_count - cindex)                         \
              * sizeof(*(array)->array_elements));                            \
    }                                                                         \
  while(0)
...
#define ARRAY_INSERT(array, index, value)                                     \
  do                                                                          \
    {                                                                         \
      ...
      memmove((array)->array_elements + cindex + 1,                           \
              (array)->array_elements + cindex,                               \
              (((array)->array_element_count - cindex)                        \
              * sizeof(*(array)->array_elements)));                           \
      (array)->array_elements[(cindex)] = value;                              \
      ++(array)->array_element_count;                                         \
    }                                                                         \
  while(0)
