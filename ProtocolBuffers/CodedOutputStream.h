...
int32_t computeDoubleSize(int32_t fieldNumber, double value);
int32_t computeFloatSize(int32_t fieldNumber, float value);
...
int32_t computeDoubleSizeNoTag(double value);
int32_t computeFloatSizeNoTag(float value);
