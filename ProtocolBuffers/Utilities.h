...
int64_t convertFloat64ToInt64(double f);
int32_t convertFloat32ToInt32(float f);
double convertInt64ToFloat64(int64_t f);
float convertInt32ToFloat32(int32_t f);
