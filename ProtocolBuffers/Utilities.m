...
int64_t convertFloat64ToInt64(double v) {
...
int32_t convertFloat32ToInt32(float v) {
...
double convertInt64ToFloat64(int64_t v) {
  union { double f; int64_t i; } u;
  u.i = v;
  return u.f;
}
...
float convertInt32ToFloat32(int32_t v) {
  union { float f; int32_t i; } u;
  u.i = v;
  return u.f;
}
