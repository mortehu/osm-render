...
static const ProtobufCFieldDescriptor osmpbf__info__field_descriptors[6] =
{
  ...
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(OSMPBF__Info, has_visible),
    PROTOBUF_C_OFFSETOF(OSMPBF__Info, visible),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const ProtobufCFieldDescriptor osmpbf__dense_info__field_descriptors[6] =
{
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_BOOL,
    PROTOBUF_C_OFFSETOF(OSMPBF__DenseInfo, n_visible),
    PROTOBUF_C_OFFSETOF(OSMPBF__DenseInfo, visible),
    NULL,
    NULL,
    1,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
